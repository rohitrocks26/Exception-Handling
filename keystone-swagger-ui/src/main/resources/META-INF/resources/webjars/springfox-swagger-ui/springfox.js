$(function() {
  ...
  window.springfox.uiConfig(function(data) {
    ...
    function addApiKeyAuthorization(security) {
      ...
      var customHeaders = {
    		   headerKey: new SwaggerClient.ApiKeyAuthorization("Cache-Control", "no-cache", "header"),
    		   anotherHeaderKey: new SwaggerClient.ApiKeyAuthorization("Pragma", "no-cache", "header")
      };
